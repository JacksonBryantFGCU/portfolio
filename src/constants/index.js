...
export const ABOUT_TEXT = `I am a dedicated and versatile front end developer with a passion for user-friendly web applications. With 1 year of professional experience, I have worked with a variety of technologies, including React, Next.js, Tailwind, and SASS. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, exploring new technologies, and contributing to open-source projects.`;
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    skills: ["Problem Solving", "Comunication", "Math Skills"],
  },
  {
    year: "2023-2024",
    ...
    skills: ["Food Service", "Teamwork", "Communication"],
  },
];
